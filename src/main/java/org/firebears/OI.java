...
public class OI {
    ...
    private JoystickButton lineFollowButton;
    private JoystickButton relativeAngleButton;
    private JoystickButton nRelativeAngleButton;
    private JoystickButton distanceButton;
