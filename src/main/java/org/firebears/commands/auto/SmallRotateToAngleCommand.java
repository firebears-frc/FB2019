...
public class SmallRotateToAngleCommand extends PIDCommand {
  ...
  public SmallRotateToAngleCommand(double angle) {
    super("SmallRotateToAngleCommand", Preferences.getInstance().getDouble("SmallRotateToAngleCommand.p", 0.0),
        Preferences.getInstance().getDouble("SmallRotateToAngleCommand.i", 0.0),
        Preferences.getInstance().getDouble("SmallRotateToAngleCommand.d", 0.0));
