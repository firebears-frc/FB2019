...
public class LeftCargoShip1Command extends ParallelCommandGroup {
  public LeftCargoShip1Command(final Chassis chassis, final Tilty tilty, final Elevator elevator, final HatchGrabber hatchGrabber) {
    super(
